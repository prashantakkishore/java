...
public interface Trie {
	...
	/**
	 * Find the best match to 'word' in this trie; uses edit distance and word
	 * frequency.
	 * 
	 * @param word
	 *            The word to approximate.
	 * @param max_time
	 *            How long before returning the current best match (via early
	 *            exit), in millis.
	 ...
	 * @param word
	 *            The word to check.
	 * @return The number of occurances of 'word' in this trie; 0 if
	 *         non-existant.
	 */
	 ...
	 * @return The number of occurances of 'word' in the trie after the
	 *         insertion.
	 */
	 ...
	 * @return True if 'word' was removed from the trie, else false (meaning
	 *         'word' wasn't in the trie).
	 */
